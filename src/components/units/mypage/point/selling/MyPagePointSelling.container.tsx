...
import { FETCH_POINT_TRANSACTIONS_OF_SELLING } from "../MyPagePoint.queries";
export default function MyPagePointSelling() {
  ...
  return (
    <S.Wrapper>
      <S.TableWrapper>
        ...
        <S.TableBody>
          {data?.fetchPointTransactionsOfSelling.map((e: any, idx: number) => (
            <S.Row key={e._id}>
